...
BEGIN TRANSACTION;
    ...
    CREATE TABLE [social].[ContentReports] (
        ...
        [IsAutoGenerated] bit NOT NULL CONSTRAINT [DF_ContentReports_IsAutoGenerated] DEFAULT ((0)),
    ...
    CREATE TABLE [social].[ContentKeywords] (
        [Id] uniqueidentifier NOT NULL,
        [Keyword] nvarchar(100) NOT NULL,
        [Action] nvarchar(20) NOT NULL CONSTRAINT [DF_ContentKeywords_Action] DEFAULT N'FLAG',
        [Category] nvarchar(50) NULL,
        [IsActive] bit NOT NULL CONSTRAINT [DF_ContentKeywords_IsActive] DEFAULT ((1)),
        [CreatedByUserId] uniqueidentifier NOT NULL,
        [CreatedAt] datetime2(3) NOT NULL CONSTRAINT [DF_ContentKeywords_Created] DEFAULT ((sysutcdatetime())),
        CONSTRAINT [PK_ContentKeywords] PRIMARY KEY ([Id]),
        CONSTRAINT [UQ_ContentKeywords_Keyword] UNIQUE ([Keyword]),
        CONSTRAINT [CK_ContentKeywords_Action] CHECK (([Action]=N'BLOCK' OR [Action]=N'FLAG'))
    );
    ...
    ALTER TABLE [social].[ContentKeywords] ADD CONSTRAINT [FK_ContentKeywords_CreatedByUser]
    ...
    CREATE INDEX [IX_ContentKeywords_IsActive] ON [social].[ContentKeywords] ([IsActive]);
